...
HRESULT PixelCube::Frame()
{
	return TRUE;
}

HRESULT PixelCube::Render()
{
	Object::Render();
...
void PixelCube::CreateVertexData()
{
	_vertices.resize(24);
...
void PixelCube::CreateIndexData()
{
	_indices.resize(36);
...
void PixelCube::SetMatrix(DxMatrix* pWorld, DxMatrix* pView, DxMatrix* pProjection)
{
