	...
	, _upSpeed(0.0f)
{
	...
	std::vector<SDL_Texture*> anims = {
		game->GetTexture("../../../Asset/SpaceShip/Ship01.png"),
		game->GetTexture("../../../Asset/SpaceShip/Ship02.png"),
		game->GetTexture("../../../Asset/SpaceShip/Ship03.png"),
		game->GetTexture("../../../Asset/SpaceShip/Ship04.png")
	};
