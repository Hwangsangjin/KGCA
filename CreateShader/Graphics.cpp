...
HRESULT Graphics::CreateVertexBuffer()
{
    ...
    Vertex vertices[] =
    {
        Vector3{ -0.15f, 0.2f, 0.0f }, Vector4{ 0.0f, 0.0f, 1.0f, 1.0f },
        Vector3{ 0.15f, 0.2f , 0.0f }, Vector4{ 0.0f, 1.0f, 0.0f, 1.0f },
        Vector3{ -0.15f, -0.2f, 0.0f }, Vector4{ 1.0f, 0.0f, 1.0f, 1.0f },
        Vector3{ -0.15f, -0.2f, 0.0f }, Vector4{ 1.0f, 0.0f, 1.0f, 1.0f },
        Vector3{ 0.15f, 0.2f, 0.0f }, Vector4{ 0.0f, 1.0f, 0.0f, 1.0f },
        Vector3{ 0.15f, -0.2f, 0.0f }, Vector4{ 1.0f, 1.0f, 0.0f, 1.0f },
    };
